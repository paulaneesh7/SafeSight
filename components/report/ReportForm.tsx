        ...
        <div className="relative group">
          ...
          <label
            ...
            className="block w-full p-8 border-2 border-dashed border-zinc-700 rounded-2xl 
                   hover:border-violet-500/50 hover:bg-violet-500/5 transition-all duration-200
                   cursor-pointer text-center"
          >
            {/* If you have an image uploaded then preview that image otherwise upload an image */}
            {image ? (
