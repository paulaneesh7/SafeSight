  ...
  return (
    <div className="w-full">
      ...
      <div className="text-center mb-8">
        <div className="inline-flex h-9 items-center gap-2 rounded-full border border-violet-500/20 bg-violet-500/10 px-4 text-sm text-violet-400">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full px-4 py-3 bg-black/50 border border-white/5 rounded-xl
                           ...
                           focus:ring-violet-500/50 focus:border-transparent transition-all"
              ...
              <button
                ...
                className="w-full bg-gradient-to-r from-violet-500 to-purple-600 
                         text-white py-3 px-4 rounded-xl hover:from-violet-400 
