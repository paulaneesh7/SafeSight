    ...
    <main className="relative px-6 pt-32 selection:bg-violet-500/20">
      <div className="mx-auto max-w-5xl">
        ...
        <div className="flex flex-col items-center text-center">
          <div className="inline-flex h-9 items-center gap-2 rounded-full border border-purple-500/20 bg-violet-500/10 px-4 text-sm text-violet-400">
            <svg
              className="h-4 w-4"
              fill="none"
              viewBox="0 0 24 24"
          ...
          <div className="mt-10 flex flex-col sm:flex-row gap-4">
            <Link href={"/submit-report"}>
              <button className="group relative flex h-12 items-center justify-center gap-2 rounded-xl bg-violet-500 px-8 text-sm font-medium text-white transition-all hover:bg-violet-400">
        ...
        <div className="mt-40 mb-20 flex justify-center">
          <div className="inline-flex items-center gap-3 rounded-full bg-zinc-900 px-5 py-2 text-sm text-zinc-400">
            ...
            Trusted by Law Enforcement Nationwide & Build by Aneesh
          </div>
        </div>
      </div>
    </main>
